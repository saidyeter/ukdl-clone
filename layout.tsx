...
import "../public/govuk-frontend-5.11.0.min.css";
import "../public/jquery-ui-custom.css";
import "../public/screen.css";
import "../public/standby.css";
import "./globals.css";
  ...
  return (
    <html lang="en">
      ...
      <body className={`${geistSans.variable} ${geistMono.variable}`}>
          ...
          <div className="header-wrapper">
            <div className="header-global">
              <div className="header-logo">
                <a href="/" title="Go to the GOV.UK homepage" id="logo" className="content">
        ...
        {children}
        <footer style={{ marginTop: 50 }} className=" group js-footer govuk-footer" id="footer" role="contentinfo">
          <div className="footer-wrapper govuk-width-container">
            <div className="footer-meta">
              <svg focusable="false" role="presentation" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 60" height="30"
                width="32" fill="currentcolor" className="govuk-footer__crown">
                <g>
                  <circle cx="20" cy="17.6" r="3.7"></circle>
                  <circle cx="10.2" cy="23.5" r="3.7"></circle>
                  <circle cx="3.7" cy="33.2" r="3.7"></circle>
              ...
              <div className="govuk-footer__meta">
                <div className="govuk-footer__meta-item govuk-footer__meta-item--grow">
                  <div className="footer-meta-inner">
                    <ul>
                      <li><a href="https://www.gov.uk/contact-driving-standards-agency-dsa">Help</a></li>
                      <li><a href="https://driverpracticaltest.dvsa.gov.uk/cookie-consent">Cookies</a></li>
                      <li><strong>English</strong></li>
                      <li lang="cy"><a
                        href="https://driverpracticaltest.dvsa.gov.uk/manage?execution=e1s1&amp;locale=cy_GB">Cymraeg</a>
                      </li>

                      <li><a href="https://driverpracticaltest.dvsa.gov.uk/accessibility">Accessibility</a></li>
                      <li><a
                        href="https://www.gov.uk/government/publications/dvsa-privacy-notices/book-and-manage-your-driving-test-privacy-policy">Privacy</a>
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <span className="govuk-footer__licence-description footer-licence-words">All content is available under
                      the
                ...
                <div className="copyright govuk-footer__meta-item">
                  <a
